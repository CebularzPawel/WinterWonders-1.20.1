package net.cebularz.winterwonders.worldgen.tree.wyrmscalefir;
...
public class WyrmscaleFirTrunkPlacer extends TrunkPlacer {
    public static final Codec<WyrmscaleFirTrunkPlacer> CODEC = RecordCodecBuilder.create(greypineTrunkPlacerInstance ->
            trunkPlacerParts(greypineTrunkPlacerInstance).apply(greypineTrunkPlacerInstance, WyrmscaleFirTrunkPlacer::new));

    public WyrmscaleFirTrunkPlacer(int pBaseHeight, int pHeightRandA, int pHeightRandB) {
