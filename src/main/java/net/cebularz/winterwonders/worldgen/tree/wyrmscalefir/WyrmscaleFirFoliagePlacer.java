...
public class WyrmscaleFirFoliagePlacer extends FoliagePlacer {
    public static final Codec<WyrmscaleFirFoliagePlacer> CODEC = RecordCodecBuilder.create(greyPineFoliagePlacerInstance
            -> foliagePlacerParts(greyPineFoliagePlacerInstance).and(Codec.intRange(0,16).fieldOf("height")
            .forGetter(fp -> fp.height)).apply(greyPineFoliagePlacerInstance, WyrmscaleFirFoliagePlacer::new));

    private final int height;

    public WyrmscaleFirFoliagePlacer(IntProvider pRadius, IntProvider pOffset, int height) {
