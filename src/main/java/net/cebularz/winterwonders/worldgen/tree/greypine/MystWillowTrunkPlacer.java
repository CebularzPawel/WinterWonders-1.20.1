...
public class MystWillowTrunkPlacer extends TrunkPlacer {
    public static final Codec<MystWillowTrunkPlacer> CODEC = RecordCodecBuilder.create(greypineTrunkPlacerInstance ->
            trunkPlacerParts(greypineTrunkPlacerInstance).apply(greypineTrunkPlacerInstance, MystWillowTrunkPlacer::new));

    public MystWillowTrunkPlacer(int pBaseHeight, int pHeightRandA, int pHeightRandB) {
