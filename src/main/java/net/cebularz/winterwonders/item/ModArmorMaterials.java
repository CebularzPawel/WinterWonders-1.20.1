...
public enum ModArmorMaterials implements ArmorMaterial {
    COLDSTEEL("coldsteel", 26, new int[]{2,7,5,2}, 12,
            SoundEvents.ARMOR_EQUIP_IRON, 1f, 0, () -> Ingredient.of(ModItems.COLDSTEEL_SWORD.get()));
    ...
    public String getName() {
        return WinterWonders.MOD_ID + ":" + this.name;
    }
