...
import net.cebularz.winterwonders.item.ModArmorItem;
import net.cebularz.winterwonders.item.ModArmorMaterials;
import net.cebularz.winterwonders.item.ModToolTiers;
