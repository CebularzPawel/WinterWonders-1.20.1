...
public class LichStaffAttackGoal extends Goal {
    ...
    public enum AttackType {
        ...
        TERRAIN_ATTACK_CLOSE,     // Floor Spikes
        TERRAIN_ATTACK_FAR,       // Ice Cubes
                ...
                switch (attackCycle) {
                    ...
                    case 2:
                        currentAttackType = distance < 100.0 ?
                                AttackType.TERRAIN_ATTACK_CLOSE : AttackType.TERRAIN_ATTACK_FAR;
                        break;
                    case 3:
            ...
            if (distance < 36.0) {
                ...
                switch (attackCycle) {
                    ...
                    case 1:
                        ...
                        break;
                    case 3:
                        currentAttackType = AttackType.TERRAIN_ATTACK_CLOSE;
                        break;
                }
            } else {
                switch (attackCycle) {
                    ...
                    case 1:
                        ...
                        break;
                    case 3:
                        currentAttackType = AttackType.TERRAIN_ATTACK_FAR;
                        break;
                }
            }
        }
    ...
    public void tick() {
        ...
        if (--this.attackTime == 0) {
            ...
            this.attackTime = Math.max(20, (int)(f * (float)(this.attackIntervalMax - this.attackIntervalMin) + (float)this.attackIntervalMin));
        }
    }
    ...
    private void executeAttack(LichBlizzardStaffItem lichStaff, LivingEntity target) {
        switch (currentAttackType) {
            case BASIC_PROJECTILE:
                lichStaff.executeProjectileAttack(target, 0);
                break;
            case SPECIAL_ATTACK:
            ...
            case BLIZZARD:
                ...
                break;
            case WHIRLWIND:
                lichStaff.executeWhirlwindAttack(target);
                break;
        }
    }
}